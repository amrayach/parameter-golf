# Local Mirror: PR #1413 faithful base

This folder is a local mirror of upstream `pr1413:records/track_10min_16mb/2026-04-06_SP8192_QK5_LegalTTT_1.0828` for
offline RunPod batch execution. It exists so A/C can run from the local repo without
an on-pod fetch.

- local record folder: `records/track_10min_16mb/2026-04-07_SP8192_QK5_LegalTTT_LocalBase`
- wrapped code bytes: `16719`
- decoded source sha256: `654fe27bace3bd3238831c6069d1f2e6c1268452dddfd03c522cea5724ba4c78`

Use:

```bash
FETCH_PAYLOAD=0 RECORD_REL=records/track_10min_16mb/2026-04-07_SP8192_QK5_LegalTTT_LocalBase bash scripts/runpod_1413.sh 0
```
